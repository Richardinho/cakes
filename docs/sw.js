    ...
    if (method === 'GET') {
      if (store.length) {
        if (isDetailRequest(url)) {
          ...
          var id = getPathSegments(url)[3];
          var cake = store.find(function (cake) {
            return cake.id == id;
          });
        ...
        if (isDetailRequest(url)) {
          ...
          return event.respondWith(fetch(event.request, { mode: 'cors' }).then(function (response) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(store, 'store', '/Users/richardhunter/development/competency-tests/waracle/src/service-worker.js');

  __REACT_HOT_LOADER__.register(isRESTRequest, 'isRESTRequest', '/Users/richardhunter/development/competency-tests/waracle/src/service-worker.js');

  __REACT_HOT_LOADER__.register(getPathSegments, 'getPathSegments', '/Users/richardhunter/development/competency-tests/waracle/src/service-worker.js');

  __REACT_HOT_LOADER__.register(isDetailRequest, 'isDetailRequest', '/Users/richardhunter/development/competency-tests/waracle/src/service-worker.js');
}();
